  ...
  return (
    <HStack m="40px auto" w="80%" gap={5} flexWrap={{base:'wrap', lg:'nowrap'}} >
        <Stack  >
            ...
            CoderBano is a cutting-edge e-learning platform that empowers students to learn coding in an engaging and effective way. With a diverse range of courses covering popular programming languages and technologies, CoderBano caters to learners of all levels, from beginners to advanced coders. The platform offers hands-on projects, interactive coding challenges, and expert guidance to help students build practical skills and confidence. CoderBano's intuitive interface and personalized learning paths ensure that every student receives a tailored learning experience. Whether you're aspiring to become a web developer, data scientist, or app designer, CoderBano provides the tools and resources you need to succeed. Join CoderBano today and start your coding journey!
            </Text>
